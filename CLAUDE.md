...
- **`docs/static/photos/`** — Photo gallery images (673 JPEGs, max 1600px). Managed via `script/update-photos`.
- **`docs/static/photos.json`** — Photo metadata (filename, date, GPS, region). Auto-generated by `script/build-photos-json`.
